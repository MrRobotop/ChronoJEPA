...
Separates across-time collapse (set by placement) from downstream order-availability (set by
architecture and feature). Synthetic by default; pass --pems for the real benchmark.
...
def main(argv: list[str] | None = None) -> dict:
    ...
    print(format_architecture_study_table(aggregate))
    print(f"\nsaved: {args.out}")
    return aggregate
